...
function renderAdvanceCheckboxes() {
    function getCheckbox(name, val) {
        return $('<div class="col-md-4"><div class="checkbox"><label><input type="checkbox" value="'
    ...
    function renderFilter(array, containerId) {
        ...
        $.each(array, function (i, e) {
            $(containerId).children('.row').append(getCheckbox(e, Math.pow(2, i)));
        });
    }
    ...
    renderFilter(['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'], '#dayPartingCheck')
    renderFilter(getHoursArray(), '#hourPartingCheck');
    renderFilter(['PC', 'Mobile'], '#deviceFilterCheck');
}
...
function setCheckedInAdvanceSetting() {
    ...
    setCheckbox(dayPartings, '#dayPartingCheck');
    setCheckbox(hourPartings, '#hourPartingCheck');
    setCheckbox(deviceFilter, '#deviceFilterCheck');
}
...
function countDayParting() {
    ...
    if (document.getElementById("Checkbox-day-parting").checked) {
...
function countHourParting() {
    var hourParting = 0;
    if (document.getElementById("Checkbox-hour-parting").checked) {
...
function countDeviceOs() {
    var DeviceOs = 0;
    if (document.getElementById("Checkbox-Device-Os").checked) {
...
function onChangeCheckboxDayParting() {
    $('#dayPartingCheck').slideToggle(100);
}

function onChangeCheckboxHourParting() {
    $('#hourPartingCheck').slideToggle(100);

}

function onChangeCheckboxDeviceOs() {
    $('#deviceFilterCheck').slideToggle(100);
}
